#line 1 "D:\\\271\254\300\333\276\367\\[ NewDTG ]\\\300\332\267\341\\STM32F2xx_StdPeriph_Lib_V0.0.4\\STM32F2xx_StdPeriph_Lib_V0.0.4\\Libraries\\STM32F2xx_StdPeriph_Driver\\src\\stm32f2xx_hash.c"
/**
  ******************************************************************************
...
/* Define to prevent recursive inclusion -------------------------------------*/
#line 182 "D:\\\271\254\300\333\276\367\\[ NewDTG ]\\\300\332\267\341\\STM32F2xx_StdPeriph_Lib_V0.0.4\\STM32F2xx_StdPeriph_Lib_V0.0.4\\Libraries\\STM32F2xx_StdPeriph_Driver\\inc\\stm32f2xx_hash.h"
/**
  * @}
  */ 
...
/******************* (C) COPYRIGHT 2011 STMicroelectronics *****END OF FILE****/
#line 28 "D:\\\271\254\300\333\276\367\\[ NewDTG ]\\\300\332\267\341\\STM32F2xx_StdPeriph_Lib_V0.0.4\\STM32F2xx_StdPeriph_Lib_V0.0.4\\Project\\STM32F2xx_StdPeriph_Template\\EWARM\\..\\..\\..\\Libraries\\STM32F2xx_StdPeriph_Driver\\inc\\stm32f2xx_hash.h"
...
/******************* (C) COPYRIGHT 2011 STMicroelectronics *****END OF FILE****/
#line 24 "D:\\\271\254\300\333\276\367\\[ NewDTG ]\\\300\332\267\341\\STM32F2xx_StdPeriph_Lib_V0.0.4\\STM32F2xx_StdPeriph_Lib_V0.0.4\\Libraries\\STM32F2xx_StdPeriph_Driver\\src\\stm32f2xx_hash.c"
...
void HASH_Init(HASH_InitTypeDef* HASH_InitStruct)
{
  ...
  if(HASH_InitStruct->HASH_AlgoMode == ((uint16_t)0x0040)) 
  {
    ...
    ((HASH_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x60400))->CR |= HASH_InitStruct->HASH_KeyType;
  }
...
void HASH_StructInit(HASH_InitTypeDef* HASH_InitStruct)
{
  ...
  HASH_InitStruct->HASH_KeyType = ((uint32_t)0x00000000);
}
...
/**
  ...
  * @note The  Number of valid bits must be set  before to start the message digest competition (in Hash and HMAC) and key treatement(in HMAC).    
...
void HASH_NbValidBits(uint16_t HASH_ValidNumber)
{
  ...
  ((HASH_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x60400))->STR |= HASH_ValidNumber;
}
...
ITStatus HASH_GetITStatus(uint8_t HASH_IT)
{
  ...
  if ((((HASH_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x60400))->SR & HASH_IT) != (uint8_t)RESET)
  {
    /* HASH_IT is set */
    bitstatus = SET;
  }
