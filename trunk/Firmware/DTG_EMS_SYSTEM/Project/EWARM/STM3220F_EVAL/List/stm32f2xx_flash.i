#line 1 "D:\\\271\254\300\333\276\367\\[ NewDTG ]\\\300\332\267\341\\STM32F2xx_StdPeriph_Lib_V0.0.4\\STM32F2xx_StdPeriph_Lib_V0.0.4\\Libraries\\STM32F2xx_StdPeriph_Driver\\src\\stm32f2xx_flash.c"
/**
  ******************************************************************************
...
/* Define to prevent recursive inclusion -------------------------------------*/
#line 330 "D:\\\271\254\300\333\276\367\\[ NewDTG ]\\\300\332\267\341\\STM32F2xx_StdPeriph_Lib_V0.0.4\\STM32F2xx_StdPeriph_Lib_V0.0.4\\Libraries\\STM32F2xx_StdPeriph_Driver\\inc\\stm32f2xx_flash.h"
/**
  * @}
  */ 
...
/******************* (C) COPYRIGHT 2011 STMicroelectronics *****END OF FILE****/
#line 28 "D:\\\271\254\300\333\276\367\\[ NewDTG ]\\\300\332\267\341\\STM32F2xx_StdPeriph_Lib_V0.0.4\\STM32F2xx_StdPeriph_Lib_V0.0.4\\Project\\STM32F2xx_StdPeriph_Template\\EWARM\\..\\..\\..\\Libraries\\STM32F2xx_StdPeriph_Driver\\inc\\stm32f2xx_flash.h"
...
/******************* (C) COPYRIGHT 2011 STMicroelectronics *****END OF FILE****/
#line 54 "D:\\\271\254\300\333\276\367\\[ NewDTG ]\\\300\332\267\341\\STM32F2xx_StdPeriph_Lib_V0.0.4\\STM32F2xx_StdPeriph_Lib_V0.0.4\\Libraries\\STM32F2xx_StdPeriph_Driver\\src\\stm32f2xx_flash.c"
 ...
 *******************************************************************************  
 ...
 --------------------------------------------------------------------------------------------------------------------     
   (*) The operating votlage can down to 1.65 V only for CSP Package.  
...
/**
  ...
  *   - VoltageRange_1: if the device voltage range: 1.8V to 2.1V, the operation will be done by byte. 
  *   - VoltageRange_2: if the device voltage range: 2.1V to 2.7V, the operation will be done by Half_word. 
  *   - VoltageRange_3: if the device voltage range: 2.7V to 3.6V , the operation will be done by word.
  *   - VoltageRange_4: if the device voltage range: 2.7V to 3.6V + External Vpp, the operation will be done 
  *     by double word.     
...
/**
  ...
  *         and an External Vpp is present.           
...
void FLASH_OB_UserConfig(uint8_t OB_IWDG, uint8_t OB_STOP, uint8_t OB_STDBY)
{
  ...
  if(status == FLASH_COMPLETE)
  { 
    optiontmp = (uint8_t)(OB_IWDG | OB_STDBY | OB_STOP)|((*(volatile uint8_t *)((uint32_t)0x40023C14)) & 0x0F); 
    /* Enable the Option Bytes Programming operation */
    *(volatile uint8_t *)((uint32_t)0x40023C14) = optiontmp; 
...
uint8_t FLASH_OB_GetBOR(void)
{
  ...
  return (((*(volatile uint8_t *)(((uint32_t)0x40023C14)) & 0x0C) >> 2));
}
...
FLASH_Status FLASH_GetStatus(void)
{
  ...
  {  
    if(((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->SR & ((uint32_t)0x00000010))
    { 
    ...
    else 
    {
      ...
      {
        if(((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->SR & ((uint32_t)0x00000002))
        {
...
{ 
  ...
  /* Wait for a Flash operation to complete by polling on BUSY flag to 
     be reset. Even if the Flash operation fails the BUSY flag will be reset
    and an error flag will be set */
