...
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  F:\Work\S&G2000\Firmware\DTG_EMS_SYSTEM\Project\nand_if /
//                    .c                                                      /
//    Command line =  F:\Work\S&G2000\Firmware\DTG_EMS_SYSTEM\Project\nand_if /
...
// F:\Work\S&G2000\Firmware\DTG_EMS_SYSTEM\Project\nand_if.c
...
//   68 	
//   69 	Temp = Index ;		// 해더 부분 데이터 띄우고 계산
//   70 
//   71 	Block = Temp / 128;
...
//   95 	
//   96 	Temp = Index ;		// 해더 부분 데이터 띄우고 계산
//   97 #ifdef NAND4G
//   98 	Blcok = Temp / 64;
//   99 	
//  100 	Address.Page = Temp - ( Blcok * 64);	
//  101 	
//  102 	Zone = Blcok / 4096;          // 총블럭 갯수 사이즈
...
//  110 	Address.Page = Temp - ( Block * 128);	
        ...
        STRH     R1,[SP, #+4]
//  111 	
//  112 	Zone = Block / 2076;          // 총블럭 갯수 사이즈
        UXTH     R2,R2            ;; ZeroExt  R2,R2,#+16,#+16
        MOVW     R1,#+2076
        SDIV     R1,R2,R1
//  113 	
