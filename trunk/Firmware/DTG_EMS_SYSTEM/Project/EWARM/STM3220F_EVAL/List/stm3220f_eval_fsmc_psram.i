#line 1 "D:\\\271\254\300\333\276\367\\[ NewDTG ]\\\300\332\267\341\\STM32F2xx_StdPeriph_Lib_V0.0.4\\STM32F2xx_StdPeriph_Lib_V0.0.4\\Utilities\\STM32_EVAL\\STM3220F_EVAL\\stm3220f_eval_fsmc_psram.c"
/**
  ******************************************************************************
...
/* Includes ------------------------------------------------------------------*/
#line 1 "D:\\\271\254\300\333\276\367\\[ NewDTG ]\\\300\332\267\341\\STM32F2xx_StdPeriph_Lib_V0.0.4\\STM32F2xx_StdPeriph_Lib_V0.0.4\\Utilities\\STM32_EVAL\\STM3220F_EVAL\\stm3220f_eval_fsmc_psram.h"
/**
  ******************************************************************************
...
/******************* (C) COPYRIGHT 2011 STMicroelectronics *****END OF FILE****/
#line 33 "D:\\\271\254\300\333\276\367\\[ NewDTG ]\\\300\332\267\341\\STM32F2xx_StdPeriph_Lib_V0.0.4\\STM32F2xx_StdPeriph_Lib_V0.0.4\\Utilities\\STM32_EVAL\\STM3220F_EVAL\\stm3220f_eval_fsmc_psram.h"
...
/******************* (C) COPYRIGHT 2011 STMicroelectronics *****END OF FILE****/
#line 25 "D:\\\271\254\300\333\276\367\\[ NewDTG ]\\\300\332\267\341\\STM32F2xx_StdPeriph_Lib_V0.0.4\\STM32F2xx_StdPeriph_Lib_V0.0.4\\Utilities\\STM32_EVAL\\STM3220F_EVAL\\stm3220f_eval_fsmc_psram.c"
...
/*-- GPIO Configuration ------------------------------------------------------*/
  ...
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1800)), &GPIO_InitStructure);
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1800)), ((uint8_t)0x09), ((uint8_t)0xC));

  /* NBL0, NBL1 configuration */
  GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0001) | ((uint16_t)0x0002); 
  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)), &GPIO_InitStructure); 

  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)),((uint8_t)0x00), ((uint8_t)0xC));
  GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)),((uint8_t)0x01), ((uint8_t)0xC));
...
/*-- FSMC Configuration ------------------------------------------------------*/
  ...
  FSMC_NORSRAMInitStructure.FSMC_Bank = ((uint32_t)0x00000002);
  FSMC_NORSRAMInitStructure.FSMC_DataAddressMux = ((uint32_t)0x00000000);
  FSMC_NORSRAMInitStructure.FSMC_MemoryType = ((uint32_t)0x00000004);
  ...
  FSMC_NORSRAMCmd(((uint32_t)0x00000002), ENABLE); 
}
...
void PSRAM_WriteBuffer(uint16_t* pBuffer, uint32_t WriteAddr, uint32_t NumHalfwordToWrite)
{
  for(; NumHalfwordToWrite != 0; NumHalfwordToWrite--) /* while there is data to write */
  {
    ...
    *(uint16_t *) (((uint32_t)0x64000000) + WriteAddr) = *pBuffer++;
...
void PSRAM_ReadBuffer(uint16_t* pBuffer, uint32_t ReadAddr, uint32_t NumHalfwordToRead)
{
  for(; NumHalfwordToRead != 0; NumHalfwordToRead--) /* while there is data to read */
  {
    ...
    *pBuffer++ = *(volatile uint16_t*) (((uint32_t)0x64000000) + ReadAddr);
