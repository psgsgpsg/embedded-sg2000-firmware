...
{  
  ...
  I2C_Send7bitAddress(EE_I2C, sEEAddress, I2C_Direction_Transmitter);
  ...
  I2C_Send7bitAddress(EE_I2C, sEEAddress, I2C_Direction_Receiver);  
  ...
  if ((uint16_t)(*NumByteToRead) < 2)
  {
    ...
    *pBuffer = I2C_ReceiveData(EE_I2C);
...
void EE_I2C_DMA_TX_IRQHandler(void)
{
  ...
  {  
    ...
    DMA_ClearFlag(EE_I2C_DMA_STREAM_TX, sEE_TX_DMA_FLAG_TCIF);
...
{
  /* Check if the DMA transfer is complete */
  if(DMA_GetFlagStatus(EE_I2C_DMA_STREAM_RX, sEE_RX_DMA_FLAG_TCIF) != RESET)
  {      
    /*!< Send STOP Condition */
    I2C_GenerateSTOP(EE_I2C, ENABLE);    
    ...
    DMA_ClearFlag(EE_I2C_DMA_STREAM_RX, sEE_RX_DMA_FLAG_TCIF);
