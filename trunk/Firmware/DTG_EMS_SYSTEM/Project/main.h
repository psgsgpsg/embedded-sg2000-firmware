...
typedef struct _BIN_NAND_CARDATA
{
     u16 Total_StartMotor;          
...
{    
     ...
     u8 Machine_Error;                  // 기어나 파킹 고장으로 EMS 동작 중지
...
#define MAX_SPEED_BUFFERCOUNT 10
#define MAX_RPM_BUFFERCOUNT 20
...
extern u32 RPM_Buffer[MAX_RPM_BUFFERCOUNT];
extern u8 SPEED_Loop;
extern u8 RPM_Loop;

extern u32 SPEED_PWM_Count;
extern u32 SPEED_Count;
extern u32 SPEED_Buffer[MAX_SPEED_BUFFERCOUNT];
extern u8 SPEED_Loop;
...
extern ACC_DRIVE_VALUE ACC_Drive_Value;
