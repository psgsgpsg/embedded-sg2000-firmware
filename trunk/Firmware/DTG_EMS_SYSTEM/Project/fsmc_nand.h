...
#define NAND_BLOCK_SIZE            ((uint16_t)0x0080) /* 128 * 8192 bytes pages per block */
#define NAND_ZONE_SIZE             ((uint16_t)0x081C) /* 2076 Block per zone */
#define NAND_SPARE_AREA_SIZE       ((uint16_t)0x01B4) /* last 64 bytes as spare area */
...
#define NAND_BLOCK_SIZE            ((uint16_t)0x0040) /* 128 * 2048 bytes pages per block */
...
#define NAND_FLASH_DELAY 5


#define PAGE_SIZE 8192
#define SPAER_SIZE 436
...
extern NAND_ADDRESS NAND_Address;
extern NAND_IDTypeDef NAND_ID;  

extern u8 NAND_Buffer[PAGE_SIZE + 1 ];
extern u8 NAND_SpearArea[SPAER_SIZE +1 ];
