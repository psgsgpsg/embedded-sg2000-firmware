...
#ifdef USB_OTG_FS_I2C_PHY_ENABLED    
    pdev->cfg.phy_itface       = USB_OTG_FS_I2C_PHY; 
#else
#ifdef USB_OTG_FS_EMBEDDED_PHY_ENABLED   
    pdev->cfg.phy_itface       = USB_OTG_FS_EMBEDDED_PHY;     
#endif
#endif  
...
#ifdef USB_OTG_HS_ULPI_PHY_ENABLED
    pdev->cfg.phy_itface       = USB_OTG_HS_ULPI_PHY;     
#ifdef USB_OTG_HS_EMBEDDED_PHY_ENABLED
    pdev->cfg.phy_itface       = USB_OTG_FS_EMBEDDED_PHY;
#else   
#ifdef USB_OTG_HS_I2C_PHY_ENABLED    
    pdev->cfg.phy_itface       = USB_OTG_FS_I2C_PHY; 
#endif
#endif  
#endif      
...
USB_OTG_STS USB_OTG_CoreInit(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  if (pdev->cfg.phy_itface == USB_OTG_HS_ULPI_PHY)
  {
  ...
  else /* FS interface (embedded Phy or I2C Phy) */
  {
    ...
    if(pdev->cfg.phy_itface == USB_OTG_FS_I2C_PHY)
    {
      gccfg.b.i2cifen = 1;
    }   
