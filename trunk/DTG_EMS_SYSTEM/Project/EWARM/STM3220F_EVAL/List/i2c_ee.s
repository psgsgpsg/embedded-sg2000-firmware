///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.10.1.52143/W32 for ARM    12/Jan/2012  04:01:46 /
// Copyright 1999-2010 IAR Systems AB.                                        /
//                                                                            /
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  F:\¹¬ÀÛ¾÷\[ NewDTG ]\WORK\DTG_EMS_SYSTEM\Project\i2c_ee /
//                    .c                                                      /
//    Command line =  "F:\¹¬ÀÛ¾÷\[ NewDTG ]\WORK\DTG_EMS_SYSTEM\Project\i2c_e /
...
// F:\¹¬ÀÛ¾÷\[ NewDTG ]\WORK\DTG_EMS_SYSTEM\Project\i2c_ee.c
...
//  388 	EETimeout = EE_LONG_TIMEOUT;
        ...
        MOVS     R1,#+614400
        STR      R1,[R0, #+0]
//  389 	while(I2C_GetFlagStatus(I2C2, I2C_FLAG_BUSY))					// Buzy ÇÃ·¡±× Ã¼Å©
??I2C_EE_BufferRead_0:
        MOVS     R1,#+131072
        LDR.N    R0,??DataTable9_3  ;; 0x40005800
        BL       I2C_GetFlagStatus
...
//  394 	I2C_GenerateSTART(I2C2, ENABLE);							// ½ÃÀÛ ½ÅÈ£
??I2C_EE_BufferRead_1:
        MOVS     R1,#+1
        LDR.N    R0,??DataTable9_3  ;; 0x40005800
        BL       I2C_GenerateSTART
...
//  403 	I2C_Send7bitAddress(I2C2, EEPROM_ADDRESS, I2C_Direction_Transmitter);			// ÁÖ¼Ò ¼±ÅÃ
??I2C_EE_BufferRead_4:
        MOVS     R2,#+0
        LDR.N    R0,??DataTable9_4
        LDRH     R1,[R0, #+0]
...
//  413 	I2C_Cmd(I2C2, ENABLE);										// ¸í·É¾î ¼±ÅÃ
??I2C_EE_BufferRead_6:
        MOVS     R1,#+1
        LDR.N    R0,??DataTable9_3  ;; 0x40005800
        BL       I2C_Cmd
...
//  416 	I2C_SendData(I2C2, ( ReadAddr >> 8 ) & 0xff);  						// »óÀ§ÁÖ¼Ò¸¦ º¸³½´Ù..
        UXTH     R6,R6            ;; ZeroExt  R6,R6,#+16,#+16
        LSRS     R1,R6,#+8
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        LDR.N    R0,??DataTable9_3  ;; 0x40005800
...
//  421 		if((EETimeout--) == 0) return EE_TIMEOUT_UserCallback();
        ...
        B.N      ??I2C_EE_BufferRead_2
//  422 	}		
//  423 	I2C_SendData(I2C2, ( ReadAddr & 0xff ) );  						// ÇÏÀ§ÁÖ¼Ò¸¦ º¸³½´Ù.
??I2C_EE_BufferRead_8:
        MOVS     R1,R6
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        LDR.N    R0,??DataTable9_3  ;; 0x40005800
...
//  432 	I2C_GenerateSTART(I2C2, ENABLE);								// ´Ù½ÃÇÑ¹ø ½ÃÀÛ ½ÅÈ£
...
//  442 	I2C_Send7bitAddress(I2C2, EEPROM_ADDRESS, I2C_Direction_Receiver);			// µð¹ÙÀÌ½º ¼¿·ºÆ®
...
//  463 		if(I2C_CheckEvent(I2C2, I2C_EVENT_MASTER_BYTE_RECEIVED))  // ·çÇÁ¿¡ ºüÁö´Â ±¸°£
